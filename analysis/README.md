...
>   configs headless through the actual `demo_vgoswec` Chrono/SEA-Stack solver at H=0.028 m
>   (A=0.014 m) and computes `P_opt` directly from the BEMIO H5 coefficients. **These are real.**
...
| `capture_efficiency_VGM0.csv`  | **real sim** | Capture-efficiency sweep (T=2.0–7.0 s) for tuned VGM-0 |
| `capture_efficiency_VGM10.csv` | **real sim** | Capture-efficiency sweep (T=2.0–7.0 s) for tuned VGM-10 |
| `capture_efficiency_VGM20.csv` | **real sim** | Capture-efficiency sweep (T=2.0–7.0 s) for tuned VGM-20 |
| `capture_efficiency_VGM45.csv` | **real sim** | Capture-efficiency sweep (T=2.0–7.0 s) for tuned VGM-45 |
| `capture_efficiency_VGM90.csv` | **real sim** | Capture-efficiency sweep (T=2.0–7.0 s) for tuned VGM-90 |
...
# 3. (REAL sim) Capture efficiency, all 5 flaps, T=2.0..7.0 s
